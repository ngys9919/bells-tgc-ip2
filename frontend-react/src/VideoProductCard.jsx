  ...
  return (
    ...
    <div className="col mb-5">
      <div className="card h-100">
        ...
        {/* <video width="240" height="320" controls autoPlay muted src={props.videoUrl} type="video/mp4"> */}
        <video width="240" height="320" controls src={props.videoUrl} type="video/mp4">
